	...
	<div class="container">
		<div class="row">
			<div class="col-md-12" style="border:1px solid gray; box-shadow: 3px 0px 3px 0px gray; color:black;border-radius:10px; width:100%; padding:10px; margin:5px;">
				<h3 style="text-shadow:2px 2px gray;">Welcome to SM Tech Blog website!</h3>
                <p>We are delighted to have you here.  
					For any comment or doubt, you can give in the <a style="background:black; color:white; border-radius:10px;" href="feedback.php">feedback</a> section </p>
			</div>
		</div>
		<div class="row">
			<!-- Blog Entries Column -->
